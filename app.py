...
if "df_staff_pool" not in st.session_state:
    st.session_state["df_staff_pool"] = pd.DataFrame([
        ...
        {"คณะ": "คณะอัญมณี", "ชื่อ-นามสกุล": "ดร.กิตติศักดิ์ มณี", "ตำแหน่ง": "อาจารย์", "ประเภท": "อาจารย์ในคณะ"},
        {"คณะ": "คณะอัญมณี", "ชื่อ-นามสกุล": "นายสมพร งามดี", "ตำแหน่ง": "นักวิชาการศึกษา", "ประเภท": "เจ้าหน้าที่สำรองส่วนกลาง"},
    ])
...
def auto_schedule_exams_combined(df_subjects, df_rooms, df_staff_pool, slots_m, slots_f, faculty_rule_map=None):
    if faculty_rule_map is None:
        faculty_rule_map = {"คณะเทคโนโลยีอุตสาหกรรมการเกษตร": 2, "คณะเทคโนโลยีสังคม": 2, "คณะอัญมณี": 2}
...
if not st.session_state["logged_in"]:
    ...
    if menu_selection == "1. จัดตารางสอบประจำเทอม":
        ...
        with fac_col3: rule_gem = st.number_input("💎 คณะอัญมณี (คน/ห้อง)", 1, 5, 2)
        faculty_rule_map = {"คณะเทคโนโลยีอุตสาหกรรมการเกษตร": rule_agri, "คณะเทคโนโลยีสังคม": rule_soc, "คณะอัญมณี": rule_gem}
